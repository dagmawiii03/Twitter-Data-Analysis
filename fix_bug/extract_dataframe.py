...
class TweetDfExtractor:
    ...
    def __init__(self, tweets_list):
        ...
        #following funtions define a function based on keyword and initiate an empty list 
        #inside to append their respective values
    ...
    def find_sentiments(self, text: list) -> list:
        # append sentiment into polarity and subjectivity in the respective list
        polarity = []
        subjectivity = []
        for tweet in text:
            blob = TextBlob(tweet)
    ...
    def get_tweet_df(self, save=False) -> pd.DataFrame:
        """required column to be generated you should be creative and add more features"""
                    # added statuses count in the column
